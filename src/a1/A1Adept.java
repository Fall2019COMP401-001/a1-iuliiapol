...
public class A1Adept {
	...
	public static void main(String[] args) {
		...
		System.out.println ("Biggest: " + firstNames[biggestSpendingIndex] + " " 
				+  lastNames[biggestSpendingIndex]
		...
		System.out.println ("Smallest: " + firstNames[smallestSpendingIndex] + " " 
				+  lastNames[smallestSpendingIndex]
